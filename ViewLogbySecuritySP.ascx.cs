<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewLogbySecuritySP.ascx.cs"
    Inherits="VMSDev.SafetyPermitUserControls.ViewLogbySecuritySP" %>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="padding-top: 10px">
                <asp:LinkButton ID="btnYes" runat="server" CssClass="cssButton" Style="text-decoration: none;
                    padding-top: 4px;" Width="60px"  Text="<%$ Resources:LocalizedText, btnYes %>"  OnClick="BtnYes_Click" Height="18px" />
                &nbsp
                <asp:LinkButton ID="btnNo" runat="server" CssClass="cssButton" Style="text-decoration: none;
                    padding-top: 4px;" Width="60px" Text="<%$ Resources:LocalizedText, btnNo %>"  PostBackUrl="~/SafetyPermitEnterInformationBySecurity.aspx"
                    Height="18px" />
            </td>
            <td>
            </td>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="grdResult" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField  HeaderText="<%$ Resources:LocalizedText, Name %>" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:Label ID="lblVName" runat="server" Text='<%# Highlight(Eval("Name").ToString()) %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField  HeaderText="<%$ Resources:LocalizedText, Company %>" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="50px">
                                            <ItemTemplate>
        ...
        <td>
            ...
            <asp:Panel ID="pnlVisitor" runat="server">
                <asp:UpdatePanel ID="UpnlVisitor" UpdateMode="Conditional" runat="server" Visible="false">
                    <ContentTemplate>
                        <center>
                            <vf:CustomPagingGrid ID="grdVisitor" runat="server" CellPadding="4" ForeColor="#333333"
                                AutoGenerateColumns="False" Font-Names="Verdana" Font-Size="X-Small" DataKeyNames="VisitorID"
                                AllowPaging="true"  GridLines="Vertical" OnRowDataBound="GrdVisitor_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="7px">
                                        <ItemTemplate>
                                            <asp:Image ID="imgVisitorImage" runat="server" ImageUrl="" Height="28px" oncontextmenu="return false" />
                                            <cc1:HoverMenuExtender ID="hme0" runat="Server" TargetControlID="imgVisitorImage"
                                                PopupControlID="pnlBig" PopupPosition="right" OffsetX="0" OffsetY="0" PopDelay="10" />
                                            <cc1:DropShadowExtender ID="dse0" runat="server" TargetControlID="pnlBig" Opacity="0.75"
                                                TrackPosition="true" />
                                            <asp:Panel ID="pnlBig" runat="server" Style="display: none;">
                                                <asp:Image ID="imgVisitorImageBig" runat="server" ImageUrl='' Height="70px" oncontextmenu="return false" />
                                            </asp:Panel>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="<%$ Resources:LocalizedText, Name %>"  ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="true"
                                        ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnName" runat="server" Text='<%# Highlight(Eval("Name").ToString()) %>'
                                                PostBackUrl='<%#"~/SafetyPermitEnterInformationBySecurity.aspx?VisitorID="+Eval("VisitorID")%>'
                                                CssClass="GridLinkButton" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="<%$ Resources:LocalizedText, Company %>" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="true"
                                        ItemStyle-Width="60px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCompany" runat="server" Text='<%# Highlight(Eval("Company").ToString()) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="<%$ Resources:LocalizedText, Designation %>"  ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="true"
                                        ItemStyle-Width="40px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDesignation" runat="server" Text='<%# Highlight(Eval("Designation").ToString()) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="<%$ Resources:LocalizedText, Mobile %>" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMobile" runat="server" Text='<%# Highlight(Eval("MobileNo").ToString()) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="<%$ Resources:LocalizedText, VisitorId %>" ItemStyle-HorizontalAlign="Center" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVisitorId" Text='<%#Eval("VisitorID") %>' runat="server"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtComments" Width="85px" />
                                        </ItemTemplate>
                        ...
                        <div class="grid">
                            <div class="pager">
                                <asp:DataPager ID="pager" runat="server" PageSize="20" PagedControlID="grdVisitor"
                                    Visible="true">
                                    <Fields>
                                        <asp:NextPreviousPagerField ButtonType="Image" FirstPageImageUrl="~/images/arrow_bar.png"
                                            ShowFirstPageButton="True" FirstPageText="<%$ Resources:LocalizedText, First %>" ShowNextPageButton="False" ShowPreviousPageButton="False" />
                                        <asp:NextPreviousPagerField ButtonType="Image" PreviousPageImageUrl="~/images/left_arrow.png"
                                            ShowNextPageButton="False"  PreviousPageText="<%$ Resources:LocalizedText, Previous %>" />
                                        <asp:NumericPagerField ButtonCount="7" NumericButtonCssClass="command" CurrentPageLabelCssClass="current"
                                            NextPreviousButtonCssClass="command" />
                                        <asp:NextPreviousPagerField ButtonType="Image"  NextPageText="<%$ Resources:LocalizedText, Next %>"  NextPageImageUrl="~/images/arrow_right.png"
                                            ShowPreviousPageButton="False" />
                                        <asp:NextPreviousPagerField ButtonType="Image" LastPageText="<%$ Resources:LocalizedText, Last %>" LastPageImageUrl="~/images/arrow_last.png"
