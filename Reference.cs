...
namespace VMSBL.OneCommunicatorService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="OneCommunicatorService.IRequestUnifiedVASContract")]
    public interface IRequestUnifiedVASContract {
        ...
        string Notify(string inputXml, VMSBL.OneCommunicatorService.MessageAttachment[] attachments);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRequestUnifiedVASContractChannel : VMSBL.OneCommunicatorService.IRequestUnifiedVASContract, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RequestUnifiedVASContractClient : System.ServiceModel.ClientBase<VMSBL.OneCommunicatorService.IRequestUnifiedVASContract>, VMSBL.OneCommunicatorService.IRequestUnifiedVASContract {
        ...
        public string Notify(string inputXml, VMSBL.OneCommunicatorService.MessageAttachment[] attachments) {
